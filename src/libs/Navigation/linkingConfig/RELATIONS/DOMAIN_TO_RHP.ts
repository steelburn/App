...
const DOMAIN_TO_RHP: Partial<Record<keyof DomainSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.DOMAIN.GROUPS]: [SCREENS.DOMAIN.GROUP_DETAILS, SCREENS.DOMAIN.GROUP_EDIT_NAME, SCREENS.DOMAIN.GROUP_CREATE, SCREENS.DOMAIN.GROUP_CREATE_PREFERRED_WORKSPACE],
};
