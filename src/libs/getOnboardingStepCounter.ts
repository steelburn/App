...
const purposeSuffixes = {
    ...
    [ONBOARDING_CHOICES.TRACK_BUSINESS]: [ONBOARDING.PERSONAL_DETAILS, ONBOARDING.WORKSPACE_OPTIONAL],
    [ONBOARDING_CHOICES.TRACK_PERSONAL]: [ONBOARDING.PERSONAL_DETAILS, ONBOARDING.WORKSPACE_OPTIONAL],
