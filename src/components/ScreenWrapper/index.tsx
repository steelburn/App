...
function ScreenWrapper({
    ...
    const doesInitialURLMatchActiveRoute = !!initialURLWithoutParams?.endsWith(activeRouteWithoutParams);
    useEffect(() => {
        Navigation.isNavigationReady().then(() => setActiveRouteWithoutParams(Navigation.getActiveRouteWithoutParams()));
    }, []);
