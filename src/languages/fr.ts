...
Voici un *reçu test* pour vous montrer comment ça fonctionne :`,
    ...
    domain: {
        ...
        groups: {
            ...
            RestrictExpenseWorkspaceCreationDescription: "Empêche les membres de créer un espace de travail de dépenses ou de se retirer d'un espace de travail de dépenses.",
            RestrictDefaultLoginSelection: 'Restreindre la sélection de connexion par défaut',
            RestrictDefaultLoginSelectionDescription: "Empêche les membres de changer leur e-mail de connexion en dehors du domaine de l'entreprise.",
            StrictlyEnforceWorkspaceRules: "Appliquer strictement les règles de l'espace de travail",
            StrictlyEnforceWorkspaceRulesDescription: "Toutes les règles de l'espace de travail doivent être respectées avant de soumettre un rapport. Aucune exception manuelle autorisée.",
            ...
            preferredWorkspaceSelectDescription: 'Toutes les nouvelles dépenses et rapports seront créés dans cet espace de travail.',
            ...
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `Êtes-vous sûr de vouloir faire de ${newName} le groupe par défaut ? Les nouveaux membres seront invités dans ce groupe au lieu du groupe par défaut précédent (${currentName}). `,
