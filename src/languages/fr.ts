...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[fr] +${count} more`,
    ...
    readOnlyConversation: '[fr] This conversation is read-only.',
    reportAction: {
        asCopilot: '[fr] as copilot for',
        assistedBy: (agentName: string) => `[fr] assisted by ${agentName}`,
        humanSupportAgent: '[fr] a human support agent',
    ...
    homePage: {
        ...
        gettingStartedSection: {
            ...
            connectAccountingDefault: '[fr] Connect to accounting',
    ...
    iou: {
        ...
        addExistingExpense: '[fr] Add existing expense',
        selectExistingExpense: '[fr] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[fr] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[fr] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[fr] Add to report',
        ...
        bulkDuplicateLimit: `[fr] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[fr] Show branch name in browser title',
        ...
        help: '[fr] Help',
        helpPage: {
            title: '[fr] Got questions?',
            description: "[fr] We're here to help, around the clock.",
            helpSite: '[fr] Help site',
            conciergeChat: '[fr] Concierge',
            conciergeChatDescription: '[fr] Your personal AI agent',
            accountManagerDescription: '[fr] Your account manager',
            partnerManagerDescription: '[fr] Your partner manager',
            guideDescription: '[fr] Your setup specialist',
        },
    ...
    cardPage: {
        ...
        spendRules: '[fr] Spend rules',
        editSpendRules: '[fr] Edit spend rules',
        reviewTransaction: '[fr] Review transaction',
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[fr] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[fr] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
    ...
    onboarding: {
        ...
        employees: {
            ...
            [CONST.ONBOARDING_COMPANY_SIZE.MICRO_SMALL]: '[fr] 1-4 employees',
            [CONST.ONBOARDING_COMPANY_SIZE.MICRO_MEDIUM]: '[fr] 5-10 employees',
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[fr] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            monthlySpendLimitLabel: '[fr] Monthly spend limit per member',
                            monthlySpendLimitDescription: '[fr] The maximum amount each member can spend on travel per month.',
                            reduceLimitTitle: '[fr] Reduce travel spend limit?',
                            reduceLimitWarning:
                                '[fr] If you reduce the limit, members who have already spent more than this amount will be unable to make new travel bookings until next month.',
                            provisioningError:
                                "[fr] We weren't able to provision some of the members of your workspace for central invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
        ...
        hr: {
            title: '[fr] HR',
            subtitle: '[fr] Connect HR tools and keep employee approvals in sync.',
            settingsTitle: '[fr] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'startingImportGusto':
                        return '[fr] Importing Gusto data';
                    case 'gustoSyncLoadCompany':
                        return '[fr] Loading Gusto company data';
                    case 'gustoSyncImportEmployees':
                        return '[fr] Importing employees';
                    case 'gustoSyncBuildApprovalChains':
                        return '[fr] Building approval chains';
                    case 'gustoSyncFinalize':
                        return '[fr] Finalizing sync';
                    case 'jobDone':
                        return '[fr] Waiting for imported data to load';
                    default: {
                        return `[fr] Translation missing for stage: ${stage}`;
            ...
            gusto: {
                title: '[fr] Gusto',
                connect: '[fr] Connect',
                connectionDescription: '[fr] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[fr] Approval mode',
                finalApprover: '[fr] Final approver',
            },
        },
        export: {
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[fr] HR integrations',
                description:
                    '[fr] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[fr] Travel',
        ...
        rules: {
            ...
            customRules: {
                ...
                policyDocument: '[fr] Policy document',
                policyText: '[fr] Policy text',
            },
            spendRules: {
                title: '[fr] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[fr] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[fr] Blocked' : '[fr] Allowed'} ${shownCount > 1 ? '[fr] merchants' : '[fr] merchant'}: ${merchants}${hiddenCount > 0 ? `[fr] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[fr] Blocked' : '[fr] Allowed'} ${shownCount > 1 ? '[fr] categories' : '[fr] category'}: ${categories}${hiddenCount > 0 ? `[fr] , +${hiddenCount} more` : ''}`,
                ...
                noCardsIssuedTitle: '[fr] No Expensify Cards issued',
                noCardsIssuedSubtitle: '[fr] Issue Expensify Cards to create spend rules',
                max: '[fr] Max',
                categoryOptions: {
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[fr] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[fr] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[fr] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[fr] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[fr] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
    ...
    search: {
        tabs: {
            ...
            expenses: '[fr] Expenses',
            submit: '[fr] Drafts',
            approve: '[fr] Needs approval',
            pay: '[fr] Ready to pay',
            accounting: '[fr] Accounting',
            export: '[fr] Awaiting export',
            unapprovedCash: '[fr] Cash accruals',
            unapprovedCard: '[fr] Card accruals',
            statements: '[fr] Card statements',
            reconciliation: '[fr] Bank reconciliation',
        ...
        bulkActions: {
            ...
            duplicateReport: ({count}: {count: number}) => `[fr] Duplicate ${count === 1 ? '[fr] report' : '[fr] reports'}`,
            undelete: '[fr] Undelete',
        ...
        filters: {
            ...
            sortOrder: {
                [CONST.SEARCH.SORT_ORDER.ASC]: '[fr] Ascending',
                [CONST.SEARCH.SORT_ORDER.DESC]: '[fr] Descending',
            },
            groupBy: {
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[fr] (Repeated ${count} times.)`,
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[fr] Credit balance',
        ...
        cancelSubscription: {
            title: '[fr] Cancel subscription',
            subtitle: '[fr] What’s the main reason you’re canceling your subscription?',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            moveToGroup: '[fr] Move to group',
            chooseWhereToMove: ({count}: {count: number}) => `[fr] Choose where to move ${count} ${count === 1 ? '[fr] member' : '[fr] members'}.`,
            error: {
                addMember: '[fr] Unable to add this member. Please try again.',
                removeMember: '[fr] Unable to remove this user. Please try again.',
                moveMember: '[fr] Unable to move this member. Please try again.',
        ...
        common: {
            ...
            error: "[fr] Couldn't save this change. Please try again.",
        },
        groups: {
            title: '[fr] Groups',
            memberCount: () => {
            ...
            defaultGroup: '[fr] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[fr] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[fr] Make default',
            neverMind: '[fr] Never mind',
        },
    },
};
