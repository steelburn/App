...
使い方がわかるように、こちらが*テスト用レシート*です。`,
    ...
    domain: {
        ...
        groups: {
            ...
            RestrictExpenseWorkspaceCreation: '経費ワークスペースの作成/削除を制限',
            RestrictExpenseWorkspaceCreationDescription: 'メンバーが経費ワークスペースを作成したり、経費ワークスペースから自分自身を削除したりすることを防ぎます。',
            RestrictDefaultLoginSelection: 'デフォルトログイン選択を制限',
            RestrictDefaultLoginSelectionDescription: 'メンバーが会社のドメインからログインメールを変更することを防ぎます。',
            StrictlyEnforceWorkspaceRules: 'ワークスペースルールを厳格に適用',
            StrictlyEnforceWorkspaceRulesDescription: 'レポートを提出する前に、すべてのワークスペースルールを満たす必要があります。手動の例外は許可されません。',
