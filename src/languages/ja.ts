...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[ja] +${count} more`,
    ...
    readOnlyConversation: '[ja] This conversation is read-only.',
    reportAction: {
        asCopilot: '[ja] as copilot for',
        assistedBy: (agentName: string) => `[ja] assisted by ${agentName}`,
        humanSupportAgent: '[ja] a human support agent',
    ...
    iou: {
        ...
        addExistingExpense: '[ja] Add existing expense',
        selectExistingExpense: '[ja] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[ja] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[ja] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[ja] Add to report',
        ...
        bulkDuplicateLimit: `[ja] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[ja] Show branch name in browser title',
        ...
        help: '[ja] Help',
        helpPage: {
            title: '[ja] Got questions?',
            description: "[ja] We're here to help, around the clock.",
    ...
    cardPage: {
        ...
        spendRules: '[ja] Spend rules',
        editSpendRules: '[ja] Edit spend rules',
        reviewTransaction: '[ja] Review transaction',
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[ja] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[ja] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[ja] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            title: '[ja] HR',
            subtitle: '[ja] Connect HR tools and keep employee approvals in sync.',
            settingsTitle: '[ja] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'startingImportGusto':
                        return '[ja] Importing Gusto data';
                    case 'gustoSyncLoadCompany':
                        return '[ja] Loading Gusto company data';
                    case 'gustoSyncImportEmployees':
                        return '[ja] Importing employees';
                    case 'gustoSyncBuildApprovalChains':
                        return '[ja] Building approval chains';
                    case 'gustoSyncFinalize':
                        return '[ja] Finalizing sync';
                    case 'jobDone':
                        return '[ja] Waiting for imported data to load';
                    default: {
                        return `[ja] Translation missing for stage: ${stage}`;
            ...
            gusto: {
                title: '[ja] Gusto',
                connect: '[ja] Connect',
                connectionDescription: '[ja] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[ja] Approval mode',
                finalApprover: '[ja] Final approver',
            },
        },
        export: {
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[ja] HR integrations',
                description:
                    '[ja] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[ja] Travel',
        ...
        rules: {
            ...
            customRules: {
                ...
                policyDocument: '[ja] Policy document',
                policyText: '[ja] Policy text',
            },
            spendRules: {
                title: '[ja] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[ja] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[ja] Blocked' : '[ja] Allowed'} ${shownCount > 1 ? '[ja] merchants' : '[ja] merchant'}: ${merchants}${hiddenCount > 0 ? `[ja] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[ja] Blocked' : '[ja] Allowed'} ${shownCount > 1 ? '[ja] categories' : '[ja] category'}: ${categories}${hiddenCount > 0 ? `[ja] , +${hiddenCount} more` : ''}`,
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[ja] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[ja] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[ja] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[ja] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[ja] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
    ...
    search: {
        tabs: {
            ...
            expenses: '[ja] Expenses',
            submit: '[ja] Drafts',
            approve: '[ja] Needs approval',
            pay: '[ja] Ready to pay',
            accounting: '[ja] Accounting',
            export: '[ja] Awaiting export',
            unapprovedCash: '[ja] Cash accruals',
            unapprovedCard: '[ja] Card accruals',
            statements: '[ja] Card statements',
            reconciliation: '[ja] Bank reconciliation',
        ...
        bulkActions: {
            ...
            duplicateReport: ({count}: {count: number}) => `[ja] Duplicate ${count === 1 ? '[ja] report' : '[ja] reports'}`,
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[ja] (Repeated ${count} times.)`,
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[ja] Credit balance',
        ...
        cancelSubscription: {
            title: '[ja] Cancel subscription',
            subtitle: '[ja] What’s the main reason you’re canceling your subscription?',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        common: {
            ...
            error: "[ja] Couldn't save this change. Please try again.",
        },
        groups: {
            title: '[ja] Groups',
            memberCount: () => {
            ...
            defaultGroup: '[ja] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[ja] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[ja] Make default',
            neverMind: '[ja] Never mind',
        },
    },
};
