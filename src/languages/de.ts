...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[de] +${count} more`,
    ...
    readOnlyConversation: '[de] This conversation is read-only.',
    reportAction: {
        asCopilot: '[de] as copilot for',
        assistedBy: (agentName: string) => `[de] assisted by ${agentName}`,
        humanSupportAgent: '[de] a human support agent',
    ...
    iou: {
        ...
        addExistingExpense: '[de] Add existing expense',
        selectExistingExpense: '[de] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[de] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[de] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[de] Add to report',
        ...
        bulkDuplicateLimit: `[de] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[de] Show branch name in browser title',
        ...
        help: '[de] Help',
        helpPage: {
            title: '[de] Got questions?',
            description: "[de] We're here to help, around the clock.",
    ...
    cardPage: {
        ...
        spendRules: '[de] Spend rules',
        editSpendRules: '[de] Edit spend rules',
        reviewTransaction: '[de] Review transaction',
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[de] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[de] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[de] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            title: '[de] HR',
            subtitle: '[de] Connect HR tools and keep employee approvals in sync.',
            settingsTitle: '[de] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'startingImportGusto':
                        return '[de] Importing Gusto data';
                    case 'gustoSyncLoadCompany':
                        return '[de] Loading Gusto company data';
                    case 'gustoSyncImportEmployees':
                        return '[de] Importing employees';
                    case 'gustoSyncBuildApprovalChains':
                        return '[de] Building approval chains';
                    case 'gustoSyncFinalize':
                        return '[de] Finalizing sync';
                    case 'jobDone':
                        return '[de] Waiting for imported data to load';
                    default: {
                        return `[de] Translation missing for stage: ${stage}`;
            ...
            gusto: {
                title: '[de] Gusto',
                connect: '[de] Connect',
                connectionDescription: '[de] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[de] Approval mode',
                finalApprover: '[de] Final approver',
            },
        },
        export: {
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[de] HR integrations',
                description:
                    '[de] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[de] Travel',
        ...
        rules: {
            ...
            customRules: {
                ...
                policyDocument: '[de] Policy document',
                policyText: '[de] Policy text',
            },
            spendRules: {
                title: '[de] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[de] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[de] Blocked' : '[de] Allowed'} ${shownCount > 1 ? '[de] merchants' : '[de] merchant'}: ${merchants}${hiddenCount > 0 ? `[de] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[de] Blocked' : '[de] Allowed'} ${shownCount > 1 ? '[de] categories' : '[de] category'}: ${categories}${hiddenCount > 0 ? `[de] , +${hiddenCount} more` : ''}`,
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[de] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[de] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[de] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[de] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[de] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
    ...
    search: {
        tabs: {
            ...
            expenses: '[de] Expenses',
            submit: '[de] Drafts',
            approve: '[de] Needs approval',
            pay: '[de] Ready to pay',
            accounting: '[de] Accounting',
            export: '[de] Awaiting export',
            unapprovedCash: '[de] Cash accruals',
            unapprovedCard: '[de] Card accruals',
            statements: '[de] Card statements',
            reconciliation: '[de] Bank reconciliation',
        ...
        bulkActions: {
            ...
            duplicateReport: ({count}: {count: number}) => `[de] Duplicate ${count === 1 ? '[de] report' : '[de] reports'}`,
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[de] (Repeated ${count} times.)`,
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[de] Credit balance',
        ...
        cancelSubscription: {
            title: '[de] Cancel subscription',
            subtitle: '[de] What’s the main reason you’re canceling your subscription?',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        common: {
            ...
            error: "[de] Couldn't save this change. Please try again.",
        },
        groups: {
            title: '[de] Groups',
            memberCount: () => {
            ...
            defaultGroup: '[de] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[de] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[de] Make default',
            neverMind: '[de] Never mind',
        },
    },
};
