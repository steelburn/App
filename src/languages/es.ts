...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        movedTransactionTo: (reportUrl, reportName) => `movió este gasto a${reportName ? ` <a href="${reportUrl}">${reportName}</a>` : ' otro informe'}`,
        movedTransactionFrom: (reportUrl, reportName) => `movió este gasto desde${reportName ? ` <a href="${reportUrl}">${reportName}</a>` : ' otro informe'}`,
