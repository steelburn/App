...
${amount} para ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        gustoApprovalWorkflowLockedTitle: 'No tan rápido...',
        gustoApprovalWorkflowLockedPrompt: 'Las aprobaciones se gestionan mediante tu integración de Gusto. Para actualizar tu flujo de aprobación, ve a la configuración de conexión de Gusto.',
