...
const translations = {
    ...
    domain: {
        ...
        members: {
            ...
            closeAccountInfo: () => ({
                one: 'We recommend closing the account safely to skip closing it in case there are: <ul><li>Pending approvals</li><li>Active reimbursements</li><li>No alternative login methods</li><br/><br/></ul>Otherwise, you can ignore the safety precautions above and force close the selected account.',
