...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[zh-hans] +${count} more`,
    ...
    readOnlyConversation: '[zh-hans] This conversation is read-only.',
    reportAction: {
        asCopilot: '[zh-hans] as copilot for',
        assistedBy: (agentName: string) => `[zh-hans] assisted by ${agentName}`,
        humanSupportAgent: '[zh-hans] a human support agent',
    ...
    iou: {
        ...
        addExistingExpense: '[zh-hans] Add existing expense',
        selectExistingExpense: '[zh-hans] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[zh-hans] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[zh-hans] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[zh-hans] Add to report',
        ...
        bulkDuplicateLimit: `[zh-hans] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[zh-hans] Show branch name in browser title',
        ...
        help: '[zh-hans] Help',
        helpPage: {
            title: '[zh-hans] Got questions?',
            description: "[zh-hans] We're here to help, around the clock.",
    ...
    cardPage: {
        ...
        spendRules: '[zh-hans] Spend rules',
        editSpendRules: '[zh-hans] Edit spend rules',
        reviewTransaction: '[zh-hans] Review transaction',
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[zh-hans] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[zh-hans] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[zh-hans] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            title: '[zh-hans] HR',
            subtitle: '[zh-hans] Connect HR tools and keep employee approvals in sync.',
            settingsTitle: '[zh-hans] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'startingImportGusto':
                        return '[zh-hans] Importing Gusto data';
                    case 'gustoSyncLoadCompany':
                        return '[zh-hans] Loading Gusto company data';
                    case 'gustoSyncImportEmployees':
                        return '[zh-hans] Importing employees';
                    case 'gustoSyncBuildApprovalChains':
                        return '[zh-hans] Building approval chains';
                    case 'gustoSyncFinalize':
                        return '[zh-hans] Finalizing sync';
                    case 'jobDone':
                        return '[zh-hans] Waiting for imported data to load';
                    default: {
                        return `[zh-hans] Translation missing for stage: ${stage}`;
            ...
            gusto: {
                title: '[zh-hans] Gusto',
                connect: '[zh-hans] Connect',
                connectionDescription: '[zh-hans] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[zh-hans] Approval mode',
                finalApprover: '[zh-hans] Final approver',
            },
        },
        export: {
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[zh-hans] HR integrations',
                description:
                    '[zh-hans] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[zh-hans] Travel',
                description:
        ...
        rules: {
            ...
            customRules: {
                ...
                policyDocument: '[zh-hans] Policy document',
                policyText: '[zh-hans] Policy text',
            },
            spendRules: {
                title: '[zh-hans] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[zh-hans] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[zh-hans] Blocked' : '[zh-hans] Allowed'} ${shownCount > 1 ? '[zh-hans] merchants' : '[zh-hans] merchant'}: ${merchants}${hiddenCount > 0 ? `[zh-hans] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[zh-hans] Blocked' : '[zh-hans] Allowed'} ${shownCount > 1 ? '[zh-hans] categories' : '[zh-hans] category'}: ${categories}${hiddenCount > 0 ? `[zh-hans] , +${hiddenCount} more` : ''}`,
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[zh-hans] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[zh-hans] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[zh-hans] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[zh-hans] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[zh-hans] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
    ...
    search: {
        tabs: {
            ...
            reports: '[zh-hans] Reports',
            expenses: '[zh-hans] Expenses',
            submit: '[zh-hans] Drafts',
            approve: '[zh-hans] Needs approval',
            pay: '[zh-hans] Ready to pay',
            accounting: '[zh-hans] Accounting',
            export: '[zh-hans] Awaiting export',
            unapprovedCash: '[zh-hans] Cash accruals',
            unapprovedCard: '[zh-hans] Card accruals',
            statements: '[zh-hans] Card statements',
            reconciliation: '[zh-hans] Bank reconciliation',
        ...
        bulkActions: {
            ...
            duplicateReport: ({count}: {count: number}) => `[zh-hans] Duplicate ${count === 1 ? '[zh-hans] report' : '[zh-hans] reports'}`,
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[zh-hans] (Repeated ${count} times.)`,
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[zh-hans] Credit balance',
        ...
        cancelSubscription: {
            title: '[zh-hans] Cancel subscription',
            subtitle: '[zh-hans] What’s the main reason you’re canceling your subscription?',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        common: {
            ...
            error: "[zh-hans] Couldn't save this change. Please try again.",
        },
        groups: {
            ...
            defaultGroup: '[zh-hans] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[zh-hans] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[zh-hans] Make default',
            neverMind: '[zh-hans] Never mind',
        },
    },
};
