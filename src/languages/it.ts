...
Ecco una *ricevuta di prova* per mostrarti come funziona:`,
    ...
    domain: {
        ...
        groups: {
            ...
            RestrictExpenseWorkspaceCreation: 'Limita la creazione/rimozione di aree di lavoro spese',
            RestrictExpenseWorkspaceCreationDescription: "Impedisce ai membri di creare un'area di lavoro spese o di rimuoversi da un'area di lavoro spese.",
            RestrictDefaultLoginSelection: 'Limita la selezione del login predefinito',
            RestrictDefaultLoginSelectionDescription: "Impedisce ai membri di cambiare la propria email di accesso dal dominio dell'azienda.",
            StrictlyEnforceWorkspaceRules: "Applica rigorosamente le regole dell'area di lavoro",
            StrictlyEnforceWorkspaceRulesDescription: "Tutte le regole dell'area di lavoro devono essere soddisfatte prima di inviare un report. Nessuna eccezione manuale consentita.",
            preferredWorkspace: 'Area di lavoro preferita',
