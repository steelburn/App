...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[pt-BR] +${count} more`,
    ...
    readOnlyConversation: '[pt-BR] This conversation is read-only.',
    reportAction: {
        asCopilot: '[pt-BR] as copilot for',
        assistedBy: (agentName: string) => `[pt-BR] assisted by ${agentName}`,
        humanSupportAgent: '[pt-BR] a human support agent',
    ...
    homePage: {
        ...
        gettingStartedSection: {
            ...
            connectAccountingDefault: '[pt-BR] Connect to accounting',
    ...
    iou: {
        ...
        addExistingExpense: '[pt-BR] Add existing expense',
        selectExistingExpense: '[pt-BR] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[pt-BR] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[pt-BR] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[pt-BR] Add to report',
        ...
        bulkDuplicateLimit: `[pt-BR] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[pt-BR] Show branch name in browser title',
        ...
        help: '[pt-BR] Help',
        helpPage: {
            title: '[pt-BR] Got questions?',
            description: "[pt-BR] We're here to help, around the clock.",
            helpSite: '[pt-BR] Help site',
            conciergeChat: '[pt-BR] Concierge',
            conciergeChatDescription: '[pt-BR] Your personal AI agent',
            accountManagerDescription: '[pt-BR] Your account manager',
            partnerManagerDescription: '[pt-BR] Your partner manager',
            guideDescription: '[pt-BR] Your setup specialist',
        },
    ...
    cardPage: {
        ...
        spendRules: '[pt-BR] Spend rules',
        editSpendRules: '[pt-BR] Edit spend rules',
        reviewTransaction: '[pt-BR] Review transaction',
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[pt-BR] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[pt-BR] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
    ...
    onboarding: {
        ...
        employees: {
            ...
            [CONST.ONBOARDING_COMPANY_SIZE.MICRO_SMALL]: '[pt-BR] 1-4 employees',
            [CONST.ONBOARDING_COMPANY_SIZE.MICRO_MEDIUM]: '[pt-BR] 5-10 employees',
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[pt-BR] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            monthlySpendLimitLabel: '[pt-BR] Monthly spend limit per member',
                            monthlySpendLimitDescription: '[pt-BR] The maximum amount each member can spend on travel per month.',
                            reduceLimitTitle: '[pt-BR] Reduce travel spend limit?',
                            reduceLimitWarning:
                                '[pt-BR] If you reduce the limit, members who have already spent more than this amount will be unable to make new travel bookings until next month.',
                            provisioningError:
                                "[pt-BR] We weren't able to provision some of the members of your workspace for central invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
        ...
        hr: {
            title: '[pt-BR] HR',
            subtitle: '[pt-BR] Connect HR tools and keep employee approvals in sync.',
            settingsTitle: '[pt-BR] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'startingImportGusto':
                        return '[pt-BR] Importing Gusto data';
                    case 'gustoSyncLoadCompany':
                        return '[pt-BR] Loading Gusto company data';
                    case 'gustoSyncImportEmployees':
                        return '[pt-BR] Importing employees';
                    case 'gustoSyncBuildApprovalChains':
                        return '[pt-BR] Building approval chains';
                    case 'gustoSyncFinalize':
                        return '[pt-BR] Finalizing sync';
                    case 'jobDone':
                        return '[pt-BR] Waiting for imported data to load';
                    default: {
                        return `[pt-BR] Translation missing for stage: ${stage}`;
            ...
            gusto: {
                title: '[pt-BR] Gusto',
                connect: '[pt-BR] Connect',
                connectionDescription: '[pt-BR] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[pt-BR] Approval mode',
                finalApprover: '[pt-BR] Final approver',
            },
        },
        export: {
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[pt-BR] HR integrations',
                description:
                    '[pt-BR] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[pt-BR] Travel',
                description:
        ...
        rules: {
            ...
            customRules: {
                ...
                policyDocument: '[pt-BR] Policy document',
                policyText: '[pt-BR] Policy text',
            },
            spendRules: {
                title: '[pt-BR] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[pt-BR] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[pt-BR] Blocked' : '[pt-BR] Allowed'} ${shownCount > 1 ? '[pt-BR] merchants' : '[pt-BR] merchant'}: ${merchants}${hiddenCount > 0 ? `[pt-BR] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[pt-BR] Blocked' : '[pt-BR] Allowed'} ${shownCount > 1 ? '[pt-BR] categories' : '[pt-BR] category'}: ${categories}${hiddenCount > 0 ? `[pt-BR] , +${hiddenCount} more` : ''}`,
                ...
                noCardsIssuedTitle: '[pt-BR] No Expensify Cards issued',
                noCardsIssuedSubtitle: '[pt-BR] Issue Expensify Cards to create spend rules',
                max: '[pt-BR] Max',
                categoryOptions: {
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[pt-BR] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[pt-BR] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[pt-BR] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[pt-BR] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[pt-BR] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
    ...
    search: {
        tabs: {
            ...
            expenses: '[pt-BR] Expenses',
            submit: '[pt-BR] Drafts',
            approve: '[pt-BR] Needs approval',
            pay: '[pt-BR] Ready to pay',
            accounting: '[pt-BR] Accounting',
            export: '[pt-BR] Awaiting export',
            unapprovedCash: '[pt-BR] Cash accruals',
            unapprovedCard: '[pt-BR] Card accruals',
            statements: '[pt-BR] Card statements',
            reconciliation: '[pt-BR] Bank reconciliation',
        ...
        bulkActions: {
            ...
            duplicateReport: ({count}: {count: number}) => `[pt-BR] Duplicate ${count === 1 ? '[pt-BR] report' : '[pt-BR] reports'}`,
            undelete: '[pt-BR] Undelete',
        ...
        filters: {
            ...
            sortOrder: {
                [CONST.SEARCH.SORT_ORDER.ASC]: '[pt-BR] Ascending',
                [CONST.SEARCH.SORT_ORDER.DESC]: '[pt-BR] Descending',
            },
            groupBy: {
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[pt-BR] (Repeated ${count} times.)`,
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[pt-BR] Credit balance',
        ...
        cancelSubscription: {
            title: '[pt-BR] Cancel subscription',
            subtitle: '[pt-BR] What’s the main reason you’re canceling your subscription?',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            moveToGroup: '[pt-BR] Move to group',
            chooseWhereToMove: ({count}: {count: number}) => `[pt-BR] Choose where to move ${count} ${count === 1 ? '[pt-BR] member' : '[pt-BR] members'}.`,
            error: {
                addMember: '[pt-BR] Unable to add this member. Please try again.',
                removeMember: '[pt-BR] Unable to remove this user. Please try again.',
                moveMember: '[pt-BR] Unable to move this member. Please try again.',
        ...
        common: {
            ...
            error: "[pt-BR] Couldn't save this change. Please try again.",
        },
        groups: {
            title: '[pt-BR] Groups',
            memberCount: () => {
            ...
            defaultGroup: '[pt-BR] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[pt-BR] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[pt-BR] Make default',
            neverMind: '[pt-BR] Never mind',
        },
    },
};
