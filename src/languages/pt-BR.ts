...
Aqui está um *comprovante de teste* para mostrar como funciona:`,
    ...
    domain: {
        ...
        groups: {
            ...
            RestrictExpenseWorkspaceCreation: 'Restringir criação/remoção de espaços de trabalho de despesas',
            RestrictExpenseWorkspaceCreationDescription: 'Impede que membros criem um espaço de trabalho de despesas ou se removam de um espaço de trabalho de despesas.',
            RestrictDefaultLoginSelection: 'Restringir seleção de login padrão',
            RestrictDefaultLoginSelectionDescription: 'Impede que membros alterem seu e-mail de login do domínio da empresa.',
            StrictlyEnforceWorkspaceRules: 'Aplicar rigorosamente as regras do espaço de trabalho',
            StrictlyEnforceWorkspaceRulesDescription: 'Todas as regras do espaço de trabalho devem ser atendidas antes de enviar um relatório. Nenhuma exceção manual permitida.',
            preferredWorkspace: 'Espaço de trabalho preferido',
            preferredWorkspaceDescription: (enabled: boolean) =>
                `Todos os novos relatórios e despesas serão criados no ${enabled ? 'espaço de trabalho preferido selecionado' : 'este espaço de trabalho'}.`,
