...
function Confirmation() {
    ...
    }, [reviewDuplicates?.taxCode, reviewDuplicates?.taxAmount, reviewDuplicates.taxAmount, duplicatedTransactionPolicy?.taxRates?.taxes, duplicatedTransaction?.taxCode]);
