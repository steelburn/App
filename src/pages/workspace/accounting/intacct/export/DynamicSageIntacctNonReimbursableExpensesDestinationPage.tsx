...
function DynamicSageIntacctNonReimbursableExpensesDestinationPage({policy}: WithPolicyConnectionsProps) {
...
export default withPolicyConnections(DynamicSageIntacctNonReimbursableExpensesDestinationPage);
