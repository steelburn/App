...
function ParticipantSearchResults({
    ...
    const onSelectRow = (option: Participant) => {
        if (
            ...
            option.policyID &&
            shouldRestrictUserBillableActions(option.policyID, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, amountOwed, currentUserPersonalDetails.accountID)
        ) {
