...
describe('MergeTransactionUtils', () => {
    ...
    describe('getDisplayValue', () => {
        it('should return empty string for empty values', () => {
            ...
            const result = getDisplayValue('merchant', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should return "Yes"/"No" for boolean values', () => {
            ...
            const reimbursableResult = getDisplayValue('reimbursable', transaction, undefined, translateLocal, convertToDisplayString);
            const billableResult = getDisplayValue('billable', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should format amount with currency', () => {
            ...
            const result = getDisplayValue('amount', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should clean HTML and line breaks from description', () => {
            ...
            const result = getDisplayValue('description', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should sanitize tag with colons', () => {
            ...
            const result = getDisplayValue('tag', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should return correct value for attendees field', () => {
            ...
            const result = getDisplayValue('attendees', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should return string values directly', () => {
            ...
            const merchantResult = getDisplayValue('merchant', transaction, undefined, translateLocal, convertToDisplayString);
            const categoryResult = getDisplayValue('category', transaction, undefined, translateLocal, convertToDisplayString);
        ...
        it('should return "None" for unreported reportID', () => {
            ...
            const result = getDisplayValue('reportID', transaction, undefined, translateLocal, convertToDisplayString);
